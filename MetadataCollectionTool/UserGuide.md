...
Data providers are the primary users for
...
- **Dataset collection** means obtaining data from participants for research, clinical, or administrative purposes.
...
The tool assumes that the user is entering governance information
for a single dataset retrospectively, after the data collection has
occurred. The user entering governance information in this tool
...
interested in requesting access to a dataset for a linkage study.
...
The tool asks users to enter governance information for a single
...
across the data lifecycle. Laws, DUAs, and consent forms
...
table that lists the questions and response values. Conditional logic built inside the tool is indicated
...
Institutional Certifications are policies associated with submission of a
...
The tool asks users to enter governance information for one
