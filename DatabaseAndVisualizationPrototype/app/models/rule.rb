class Rule < ApplicationRecord
  ...
  ACTIONS = ['access', 'anonymize', 'approve', 'classify', 'collect', 'completeTraining', 'deidentify', 'link',
             'makeDetermination', 'obtainApproval','obtainConsent', 'reidentify', 'researchUse', 'reviewPolicy',
